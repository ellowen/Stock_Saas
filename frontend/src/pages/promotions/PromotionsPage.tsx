  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      <PageHeader
        ...
        actions={
          canManage && (
            <button type="button" onClick={openCreate} className="px-4 py-2 text-sm font-medium rounded-lg bg-primary-600 text-white hover:bg-primary-700 transition-colors">
              {t("promotions.new")}
            </button>
          )
        }
